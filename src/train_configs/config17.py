...
class config:
    ...
    swa_lr = 1e-3
    crop_p = 0.999
    crop_csv_path = '/home/kaor/whale_code/yolo/train_bbox.csv' #new yolo
    crop_backfin_csv_path = '/home/kaor/whale_code/yolo/train_bbox_backfin.csv'
    use_crop_for_val = True
    ### torch
    model = {'f_class': "models.convnext.get_model",
             "args": {
                     'backbone_name':'convnext_xlarge_384_in22ft1k',
                     'num_calss_id':15587,
                     'num_calss':30}}
    ...
    train_transforms = albumentations.Compose([
            ...
            albumentations.Cutout(max_h_size=int(size * 0.25), max_w_size=int(size * 0.25), num_holes=1, p=0.5),
