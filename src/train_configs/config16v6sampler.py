...
class config:
    exp_name = 'exp16v6sampler'
    seed = 42
    epochs = 25
    kfold_csv = '/home/kaor/whale_code/csv/fold2.csv'
    n_folds = 5
    log_DIR = '/home/kaor/whale_code/log/'
    save_dir = '/home/kaor/whale_code/output/'
    load_from = ['/home/kaor/whale_code/output/exp16pretrain_fold0_best.pth'] * 5
    old_model_head_dim = 5004
    debug=False
    apex=True
    print_freq=100
    val_freq = 3
    ...
    swa_lr = 1e-3
    crop_p = 0.999
    crop_csv_path = '/home/kaor/whale_code/yolo/train_bbox3.csv' #new yolo
    crop_backfin_csv_path = '/home/kaor/whale_code/yolo/train_bbox_backfin2.csv'
    ...
    criterion = [{'f_class': "torch.nn.CrossEntropyLoss","args": {},'name':"arcface" , 'w':0.5,"label":"label"},
                {'f_class': "torch.nn.CrossEntropyLoss","args": {},'name':"species", 'w':0.05,"label": "species"},
                {'f_class': "models.triplet_loss.TripletLoss","args": {"margin":0.3},'name':"feature", 'w':0.45,"label": "label"},
                ]
