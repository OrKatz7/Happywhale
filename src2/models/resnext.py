...
def get_model(backbone_name='gluon_seresnext101_32x4d',num_calss_id=15587,num_calss=30):
    # create backbone


    backbone = timm.create_model(backbone_name, pretrained=True,in_chans=3)
