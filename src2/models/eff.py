...
def get_model(backbone_name='tf_efficientnet_b0_ns',num_calss_id=15587,num_calss=30,in_chans=3):
    # create backbone
    ...
    if 'efficientnet' in backbone_name:
        ...
        backbone = timm.create_model(backbone_name, pretrained=True,in_chans=in_chans, **kwargs)
